...
-(void)crearPlatosSushi{
    ...
    sushi1.fuente_img_grande = @"anagomaki_big.png";
    sushi1.fuente_img_peq = @"btn_sushi.png";
    sushi1.precio = 12000;
    ...
    sushi2.fuente_img_grande = @"avocadocrispyroll_big.png";
    sushi2.fuente_img_peq = @"btn_sushi.png";
    sushi2.precio = 15000;
    ...
    sushi3.fuente_img_grande = @"bananguilsweet_big.png";
    sushi3.fuente_img_peq = @"btn_sushi.png";
    sushi3.precio = 18000;
    ...
    sushi4.fuente_img_grande = @"californiaroll_big.png";
    sushi4.fuente_img_peq = @"btn_sushi.png";
    sushi4.precio = 11000;
    ...
    sushi5.fuente_img_grande = @"californiaspicy_big.png";
    sushi5.fuente_img_peq = @"btn_sushi.png";
    sushi5.precio = 10000;
    ...
    sushi6.fuente_img_grande = @"crazyroll_big.png";
    sushi6.fuente_img_peq = @"btn_sushi.png";
    sushi6.precio = 13000;
    ...
    sushi7.fuente_img_grande = @"ebikanroll_big.png";
    sushi7.fuente_img_peq = @"btn_sushi.png";
    sushi7.precio = 14000;
    ...
    sushi8.fuente_img_grande = @"ebiroll_big.png";
    sushi8.fuente_img_peq = @"btn_sushi.png";
    sushi8.precio = 16000;
    ...
    sushi9.fuente_img_grande = @"ebitempura_big.png";
    sushi9.fuente_img_peq = @"btn_sushi.png";
    sushi9.precio = 17000;
    ...
    sushi10.fuente_img_grande = @"ebitropical_big.png";
    sushi10.fuente_img_peq = @"btn_sushi.png";
    ...
    sushi11.fuente_img_grande = @"ellsakeroll_big.png";
    sushi11.fuente_img_peq = @"btn_sushi.png";
    ...
    sushi12.fuente_img_grande = @"fabiroll_big.png";
    sushi12.fuente_img_peq = @"btn_sushi.png";
    ...
    sushi13.fuente_img_grande = @"hotcreamroll_big.png";
    sushi13.fuente_img_peq = @"btn_sushi.png";
    ...
    sushi14.fuente_img_grande = @"jensroll_big.png";
    sushi14.fuente_img_peq = @"btn_sushi.png";
    ...
    sushi15.fuente_img_grande = @"jhoelsroll_big.png";
    sushi15.fuente_img_peq = @"btn_sushi.png";
    ...
    sushi16.fuente_img_grande = @"kaniroll_big.png";
    sushi16.fuente_img_peq = @"btn_sushi.png";
    ...
    sushi17.fuente_img_grande = @"kanizu_big.png";
    ...
    sushi18.fuente_img_grande = @"kappamaki_big.png";
    sushi18.fuente_img_peq = @"btn_sushi.png";
    ...
    sushi19.fuente_img_grande = @"katsuroll_big.png";
    sushi19.fuente_img_peq = @"btn_sushi.png";
    ...
    sushi20.fuente_img_grande = @"magicroll_big.png";
    sushi20.fuente_img_peq = @"btn_sushi.png";
    ...
    sushi21.fuente_img_grande = @"marmariroll_big.png";
    sushi21.fuente_img_peq = @"btn_sushi.png";
    ...
    sushi22.fuente_img_grande = @"ojodetigre_big.png";
    sushi22.fuente_img_peq = @"btn_sushi.png";
    ...
    sushi23.fuente_img_grande = @"peachrollmix_big.png";
    sushi23.fuente_img_peq = @"btn_sushi.png";
    ...
    sushi24.fuente_img_grande = @"philadelphiaroll_big.png";
    sushi24.fuente_img_peq = @"btn_sushi.png";
    ...
    sushi25.fuente_img_grande = @"rainbowroll_big.png";
    sushi25.fuente_img_peq = @"btn_sushi.png";
    ...
    sushi26.fuente_img_grande= @"sakemaki_big.png";
    sushi26.fuente_img_peq = @"btn_sushi.png";
    ...
    sushi27.fuente_img_grande= @"saketempuraroll_big.png";
    sushi27.fuente_img_peq = @"btn_sushi.png";
    ...
    sushi28.fuente_img_grande = @"skinroll_big.png";
    sushi28.fuente_img_peq = @"btn_sushi.png";
    ...
    sushi29.fuente_img_grande = @"sonanroll_big.png";
    sushi29.fuente_img_peq = @"btn_sushi.png";
    ...
    sushi30.fuente_img_grande = @"spicyrollsake_big.png";
    sushi30.fuente_img_peq = @"btn_sushi.png";
    ...
    sushi31.fuente_img_grande = @"spicyrolltuna_big.png";
    sushi31.fuente_img_peq = @"btn_sushi.png";
    ...
    sushi32.fuente_img_grande = @"spiderroll_big.png";
    sushi32.fuente_img_peq = @"btn_sushi.png";
    ...
    sushi33.fuente_img_grande = @"takoroll_big.png";
    sushi33.fuente_img_peq = @"btn_sushi.png";
    ...
    sushi34.fuente_img_grande= @"tekkamaki_big.png";
    sushi34.fuente_img_peq = @"btn_sushi.png";
    ...
    sushi35.fuente_img_grande = @"tiraditoroll_big.png";
    sushi35.fuente_img_peq = @"btn_sushi.png";
    ...
    sushi36.fuente_img_grande = @"tropicalroll_big.png";
    sushi36.fuente_img_peq = @"btn_sushi.png";
    ...
    sushi37.fuente_img_grande = @"vegetariano_big.png";
    sushi37.fuente_img_peq = @"btn_sushi.png";
    ...
    sushi38.fuente_img_grande = @"wasabiroll_big.png";
    sushi38.fuente_img_peq = @"btn_sushi.png";
    ...
    sushi39.fuente_img_grande = @"yolscarroll_big.png";
    sushi39.fuente_img_peq = @"btn_sushi.png";
...
-(void)crearPlatosSopa{
    ...
    sopa1.fuente_img_grande = @"anagomaki_big.png";
    sopa1.fuente_img_peq = @"btn_sopas.png";
    sopa1.precio = 8000;
    sopa1.tipo = tipoSopa;
...
-(void)crearPlatosEntradas{
    ...
    entrada2.nombre = @"Anagomaki";
    entrada2.fuente_img = @"entrada_eby-crispy.png";
    entrada2.fuente_img_grande = @"entrada_eby-crispy.png";
    entrada2.fuente_img_peq = @"entrada_eby-crispy_p.png";
    entrada2.precio = 8000;
    entrada2.tipo = tipoEntradas;
    
    if(entrada3==nil) entrada3 = [[Plato alloc]init];
    entrada3.id_plato =503;
    entrada3.nombre = @"Anagomaki";
    entrada3.fuente_img = @"entrada_eby-crispy.png";
    entrada3.fuente_img_grande = @"entrada_eby-crispy.png";
    entrada3.fuente_img_peq = @"entrada_eby-crispy_p.png";
    entrada3.precio = 8000;
    entrada3.tipo = tipoEntradas;
    
    if(entrada4==nil) entrada4 = [[Plato alloc]init];
    entrada4.id_plato =504;
    entrada4.nombre = @"Anagomaki";
    entrada4.fuente_img = @"entrada_eby-crispy.png";
    entrada4.fuente_img_grande = @"entrada_eby-crispy.png";
    entrada4.fuente_img_peq = @"entrada_eby-crispy_p.png";
    entrada4.precio = 8000;
    entrada4.tipo = tipoEntradas;
    
    if(entrada5==nil) entrada5 = [[Plato alloc]init];
    entrada5.id_plato =505;
    entrada5.nombre = @"Anagomaki";
    entrada5.fuente_img = @"entrada_eby-crispy.png";
    entrada5.fuente_img_grande = @"entrada_eby-crispy.png";
    entrada5.fuente_img_peq = @"entrada_eby-crispy_p.png";
    entrada5.precio = 8000;
    entrada5.tipo = tipoEntradas;
    
    if(entrada6==nil) entrada6 = [[Plato alloc]init];
    entrada6.id_plato =506;
    entrada6.nombre = @"Anagomaki";
    entrada6.fuente_img = @"entrada_eby-crispy.png";
    entrada6.fuente_img_grande = @"entrada_eby-crispy.png";
    entrada6.fuente_img_peq = @"entrada_eby-crispy_p.png";
    entrada6.precio = 8000;
    entrada6.tipo = tipoEntradas;
    
    if(entrada7==nil) entrada7 = [[Plato alloc]init];
    entrada7.id_plato =507;
    entrada7.nombre = @"Anagomaki";
    entrada7.fuente_img = @"entrada_eby-crispy.png";
    entrada7.fuente_img_grande = @"entrada_eby-crispy.png";
    entrada7.fuente_img_peq = @"entrada_eby-crispy_p.png";
    entrada7.precio = 8000;
    entrada7.tipo = tipoEntradas;
    
    if(entrada8==nil) entrada8 = [[Plato alloc]init];
    entrada8.id_plato =508;
    entrada8.nombre = @"Anagomaki";
    entrada8.fuente_img = @"entrada_eby-crispy.png";
    entrada8.fuente_img_grande = @"entrada_eby-crispy.png";
    entrada8.fuente_img_peq = @"entrada_eby-crispy_p.png";
    entrada8.precio = 8000;
    entrada8.tipo = tipoEntradas;
    
    if(entrada9==nil) entrada9 = [[Plato alloc]init];
    entrada9.id_plato =509;
    entrada9.nombre = @"Anagomaki";
    entrada9.fuente_img = @"entrada_eby-crispy.png";
    entrada9.fuente_img_grande = @"entrada_eby-crispy.png";
    entrada9.fuente_img_peq = @"entrada_eby-crispy_p.png";
