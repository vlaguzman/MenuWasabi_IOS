...
BOOL bool_swipe_entradas = YES;


@implementation EntradasLayer
...
+(CCScene *) scene
{
	...
	EntradasLayer *layer = [EntradasLayer node];
...
+(CCScene *) sceneWithVC:(RootViewController *)rootViewController
{
    ...
    EntradasLayer *layer = [[[EntradasLayer alloc]
